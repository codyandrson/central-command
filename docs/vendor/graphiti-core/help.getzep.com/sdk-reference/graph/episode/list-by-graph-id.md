...
POST https://api.getzep.com/api/v2/graph/episodes/graph/{graph_id}
Content-Type: application/json

Returns a paginated, filterable list of episodes for a graph.

Reference: https://help.getzep.com/sdk-reference/graph/episode/list-by-graph-id
...
func do() {
    ...
    client.Graph.Episode.ListByGraphID(
        context.TODO(),
        "graph_id",
        request,
    )
