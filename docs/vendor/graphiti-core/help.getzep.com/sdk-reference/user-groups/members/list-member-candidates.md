...
GET https://api.getzep.com/api/v2/user-groups/{groupUUID}/members/candidates

Reference: https://help.getzep.com/sdk-reference/user-groups/members/list-member-candidates
