...
Custom entity types and edge types let you structure your knowledge graph to match your domain. They enable more precise extraction, better organization, and richer semantic relationships in your data.