...
> **Status:** implemented — Executor RETRY_PENDING + idempotent replay — secondary record, see `../specs/2026-07-31-outage-equivalence-design.md`
> **As-built:** `central_command/gateway/gateway.py`
