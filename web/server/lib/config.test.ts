...
// Keep the suite hermetic: config.ts imports 'dotenv/config', which would load
// the deployment's real web/.env (NERVE_AUTH=true on the Pi) into the cached
// module snapshot and break the "defaults" tests.
