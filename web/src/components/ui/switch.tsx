  ...
  ({ checked, onCheckedChange, disabled = false, className = "", id, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy }, ref) => {
    return (
      <button
        ...
        className={`relative inline-flex h-6 w-10 shrink-0 cursor-pointer items-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 ${
