...
export function ConfirmDialog({
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 bg-background/78" role="presentation" onClick={onCancel} />
      <div
        ref={dialogRef}
        role="alertdialog"
        aria-modal="true"
        ...
        className="fixed top-1/2 left-1/2 z-50 min-w-[320px] max-w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-border/75 bg-card/94 p-6 shadow-[0_36px_90px_rgba(0,0,0,0.42)]"
      >
