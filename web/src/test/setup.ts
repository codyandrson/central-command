...
// jsdom ships no ResizeObserver, and react-resizable-panels constructs one in a
// layout effect — without this every panel group throws on mount. jsdom has no
// layout engine, so it could never fire anyway: a no-op is the whole shim.
