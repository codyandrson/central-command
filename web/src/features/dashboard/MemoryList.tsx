        ...
        {initialLoading && !memories.length ? (
          ...
          <div className="flex items-center border-b border-border/40">
            ...
            <button
              ...
              disabled={isLoading}
              className="shrink-0 px-2 py-2 bg-transparent border-0 text-muted-foreground hover:text-foreground disabled:opacity-50 transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-purple/50 focus-visible:ring-offset-0"
