      ...
      <DialogPortal>
        ...
        >
          ...
          <div className="absolute top-4 right-4 flex gap-2" onClick={(e) => e.stopPropagation()}>
            <button
              className="text-white/70 hover:text-white text-xs font-mono cursor-pointer bg-black/50 hover:bg-black/70 rounded-md px-3 py-2 flex items-center gap-1.5 transition-colors border border-white/10"
            ...
            <button
              className="text-white/70 hover:text-white text-2xl font-mono cursor-pointer bg-black/50 hover:bg-black/70 rounded-full w-9 h-9 flex items-center justify-center transition-colors border border-white/10"
              onClick={() => setOpen(false)}
              aria-label="Close"
            >
              ×
