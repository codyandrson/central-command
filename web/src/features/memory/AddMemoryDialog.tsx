          ...
          <div className="space-y-2">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {sectionDropdownOpen && filteredSections.length > 0 && (
                <div className="absolute z-50 mt-2 max-h-48 w-full overflow-y-auto rounded-2xl border border-border/80 bg-card/98 p-1 shadow-[0_20px_48px_rgba(0,0,0,0.28)]">
