...
import { COLUMNS, boardColumnFor } from './types';
...
export const KanbanBoard = memo(function KanbanBoard({
  ...
  const localTasksByStatus = useCallback(
    (status: TaskStatus): KanbanTask[] =>
      localTasks.filter(t => boardColumnFor(t) === status).sort((a, b) => a.columnOrder - b.columnOrder),
    [localTasks],
  );
    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="max-w-[420px] text-center select-none">
          ...
          <h3 className="text-balance text-[1.067rem] font-bold text-foreground mb-1.5">No tasks yet</h3>
