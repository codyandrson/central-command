...
describe('ConnectDialog', () => {
  ...
  it('connects with an empty token when auth is disabled, even without serverSideAuth', async () => {
    const onConnect = vi.fn();
    render(
      <ConnectDialog
        open
  ...
  it('still requires a token when auth is enabled and serverSideAuth is off', () => {
    const onConnect = vi.fn();
    render(
      <ConnectDialog
        open
