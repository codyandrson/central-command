  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed right-0 top-0 z-50 flex h-full w-full flex-col overflow-hidden border-l border-border/80 bg-card/92 shadow-[0_32px_90px_rgba(0,0,0,0.36)] animate-slide-in-right sm:w-[410px] sm:max-w-[94vw]"
      >
        {/* Header */}
